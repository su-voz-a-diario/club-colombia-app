...
export default function QRGenerator({ studentName = "Atleta de Prueba", status = "active", token = "CC-2026-9981" }) {
  ...
  return (
    <div className="flex flex-col items-center justify-center p-6 bg-[#0e121e] border border-slate-800 rounded-3xl w-full max-w-[300px] relative overflow-hidden shadow-2xl">
      ...
      <div className="relative p-4 bg-white rounded-2xl z-10 shadow-lg">
        ...
        <svg width="150" height="150" viewBox="0 0 29 29" shapeRendering="crispEdges" className="text-slate-900 fill-current">
          ...
          {/* Bloques de Datos Pseudo-Aleatorios */}
          ...
          <path d="M13.5 13.5h2v2h-2z" fill={status === "active" ? "#10b981" : "#d97706"} />
        </svg>
      ...
      <div className="text-center mt-5 z-10 w-full">
        ...
        {status !== "active" && (
          <p className="text-[10px] text-amber-500/95 font-semibold mt-3 animate-pulse bg-amber-500/10 py-1 px-2 rounded-lg border border-amber-500/20">
