...
4.  **Simulador de Mercado Pago:** El sistema abre una ventana de pago segura. Eliges Tarjeta de Crédito o PSE y haces clic en **Pagar**.
5.  **Activación de Credencial:** Al confirmarse el pago ficticio, el sistema genera la **Credencial QR activa** del menor para que pueda ingresar al entrenamiento.
...
*   **Dictado por Voz con IA:** En lugar de escribir reportes largos bajo el sol, el entrenador presiona el botón del **Micrófono**; el sistema simula escuchar su voz y escribe automáticamente observaciones tácticas profesionales. Al presionar "Publicar", el reporte se envía de inmediato al perfil del papá.
...
*   **Credencial Digital QR:** Es el pase de entrada del niño. 
    ...
    *   *Si la mensualidad tiene mora:* El QR se bloquea en **Rojo (Suspendido)**. Justo abajo se activa el botón de pago de Mercado Pago. Al realizar el pago simulado, el QR se reactiva a color verde al instante.
